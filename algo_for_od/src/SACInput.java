...
*  Yet you dont know that I love you.”中提炼出的单词，符合“f”作为前缀的，有“furthest”和“front”，按字典序排序并在单词间添加空格后输出，
* 结果为“front furthest”。*/
public class SACInput {
    ...
    public static String getResult(String str, String pre) {
        ...
        // 不能在这就直接输出了 因为还有找不到输出前缀的情况
        set.stream().filter(s -> s.startsWith(pre)).forEach(s -> sj.add(s));
